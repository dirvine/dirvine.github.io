<?php $title="Privacy Security Freedom, MaidSafe"; ?>
<?php $metakeywords="Privacy Security Freedom, MaidSafe"; ?>
<?php $metadescription="MaidSafe strive to deliver privacy, security and freedom online."; ?>
...
<div class="container-12">
    ...
    <div class="col-l">
    <h2>Privacy</h2>
    <p>We believe the ability to simply open a file or look at an image without divulging any information about yourself is key to the growth in data sharing and knowledge transfer. Yet we pay for many 'free systems' on the internet with the very privacy that we have guarded for years.</p>
    ...
    <p>The data in The MaidSafe Network is 'on your local disk' and appears as 'physical data' on the hard drive of your computer or any computer/mobile device you decide to login and use.</p>
    </div>
    </div>
    <div class="grid-4">
    <div class="col-m">
    ...
    <p>To ensure your complete security  MaidSafe's self encryption and authentication software is so powerful  that it is currently unbreakable by any existing means. You can safely  share folders and back up data with the absolute certainty that only  individuals with the correct password information are able to access it.</p>
    </div>
    </div>
    <div class="grid-4 r">
    <div class="col-r">
    <h2>Freedom</h2>
    <p>Freedom is a dream for many people today and  an illusion of many others. The freedom to think, freedom to roam and  the freedom to communicate thoughts and desires are either sought after  or perceived as already attained by the majority of us.</p>
...
<h1>The MaidSafe Team</h1>
    ...
    <h2>Stephen Cosh</h2>
    <h3>Joint CEO</h3>
    <p>Stephen is a driven entrepreneur with 20 years consumer marketing  experience at management level and 15 years at director level. He has  founded and successfully exited 3 companies. Stephen is responsible for  business and software strategy at MaidSafe. Stephen is married with 2  children and is an avid watch collector. When he gets the chance he  makes time for fishing and can often be seen out and about expanding his  street photography portfolio.</p>
    </div>
    </div>
    </div>
    ...
    <p>Nick has an MSc in Marketing and has spent the last 10 years in senior  marketing positions. Prior to that he fulfilled project management roles  within large blue chip technology companies. Nick is responsible for  sales and marketing, intellectual property, user support and MaidSafe&rsquo;s  revenue streams.</p>
    </div>
    </div>
    </div>
