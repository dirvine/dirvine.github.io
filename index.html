											var title="Distributed Platform, MaidSafe"; var metakeywords="Distributed Platform, MaidSafe"; var metadescription="MaidSafe's distributed platform enables the creation of fast and secure applications that help ensure digital privacy, security and freedom for all."; 
<body id="home">
<div id="container">
    <div id="main">
