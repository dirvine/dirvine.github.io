...
function emailFormSubmission()
{
	...
	$subject = 'Website - Investor Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U89"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Company:</b></td><td>' . htmlentities($_REQUEST["custom_U105"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Work Address:</b></td><td>' . htmlentities($_REQUEST["custom_U70"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>City:</b></td><td>' . htmlentities($_REQUEST["custom_U120"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>State:</b></td><td>' . htmlentities($_REQUEST["custom_U75"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Postcode / Zip:</b></td><td>' . htmlentities($_REQUEST["custom_U80"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Country:</b></td><td>' . htmlentities($_REQUEST["custom_U115"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U94"],ENT_COMPAT,'UTF-8') . '</td></tr>';
